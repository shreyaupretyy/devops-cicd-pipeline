...
Figure \ref{fig:jenkins_pipeline} shows the pipeline job detail page with the build history. Build \#2 successfully completed all five stages: Checkout, Install Dependencies, Run Tests (all 5 Jest tests passed), Build Docker Image, and Deploy via Ansible.
